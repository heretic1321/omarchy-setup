...
# Configuration
BINDINGS_FILE="$HOME/.config/hypr/user_overrides/bindings.conf"
...
main() {
    ...
    if [[ "$selected_items_have_bindings" == true ]]; then
        ...
        gum style \
            --foreground 51 \
            --italic \
            "Do you want to remove their keyboard shortcuts from ~/.config/hypr/user_overrides/bindings.conf?"
